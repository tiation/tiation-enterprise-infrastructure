---
layout: default
title: Parrot Security Guide - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Parrot Security Guide</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/Parrot-Security-Guide" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t Parrot-Security-Guide .

# Run container
docker run -p 8080:8080 Parrot-Security-Guide
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/Parrot-Security-Guide)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/Parrot-Security-Guide/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/Parrot-Security-Guide/discussions)
