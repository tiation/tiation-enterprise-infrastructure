...
# tiation-docker-debian - Enterprise Deployment Script
...
PROJECT_NAME="tiation-docker-debian"
PROJECT_TYPE="documentation-site"
DEFAULT_DOMAIN="tiation-docker-debian.surge.sh"
FEATURES="documentation,code-examples,architecture-diagrams,security-guides"
